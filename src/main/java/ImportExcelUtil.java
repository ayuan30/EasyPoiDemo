...
public class ImportExcelUtil {
    public static String[] zeroArr=new String[]{"0","0","0","0","0","0","0","0"};

    public static void goodPrice3(Map<String, String[]> map, String companyName) {
        ...
        String[] goodPriceArr = new String[8];

        goodPriceArr[4] = cutNetProfitArr[cutNetProfitArr.length-1];
        goodPriceArr[5] = cutNetProfitRateArr[cutNetProfitRateArr.length-1];
        goodPriceArr[6] = otherDataArr[2];//我给的增长率
        goodPriceArr[7] = otherDataArr[3];//我给的市盈率
        Double rate2=Double.valueOf(goodPriceArr[6].replace("%", ""));
        goodPriceArr[0] = ((Double.valueOf(goodPriceArr[4]) * (1 + rate2/100) * Double.valueOf(goodPriceArr[7])) / (Double.valueOf(otherDataArr[4]) * 100000000))*0.7 + "";
        goodPriceArr[1] = ((Double.valueOf(goodPriceArr[4]) * (1 + rate2/100) * Double.valueOf(goodPriceArr[7])) / (Double.valueOf(otherDataArr[4]) * 100000000))*0.9 + "";

        goodPriceArr[2] = ((Double.valueOf(goodPriceArr[4]) * pow((1 + rate2/100),3) * Double.valueOf(goodPriceArr[7])) / (Double.valueOf(otherDataArr[4]) * 100000000))*0.7 + "";
        goodPriceArr[3] = ((Double.valueOf(goodPriceArr[4]) * pow((1 + rate2/100),3) * Double.valueOf(goodPriceArr[7])) / (Double.valueOf(otherDataArr[4]) * 100000000))*0.9 + "";
    ...
    public static void payableNoteAdvanceReceiptsTotalMinus(Map<String, String[]> map) {
        ...
        if(receivableArr==null){
            receivableArr = map.get("应收账款(元)");
        }
        if(receivableArr==null){
            receivableArr=zeroArr;
        }
    ...
    public static void roeRate(Map<String, String[]> map) {
        ...
        if(netProfitParentArr==null){
            netProfitParentArr=zeroArr;
        }
        ...
        for (int i = 0; i < work.getNumberOfSheets(); i++) {
            ...
            for (int j = 1; j < sheet.getLastRowNum() + 5; j++) {
                ...
                if (fileName.contains("other_data")) {
                    ...
                    String[] valueArr = new String[endCol];
